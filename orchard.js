...
// ... (calculate total pounds after defining fujiTons, galaTons, and pinkTons)

// Now, you can calculate total pounds
let totalFujiPounds = fujiTons.reduce((total, tons) => total + tons * 2000, 0);
let totalGalaPounds = galaTons.reduce((total, tons) => total + tons * 2000, 0);
let totalPinkPounds = pinkTons.reduce((total, tons) => total + tons * 2000, 0);
